 ...
 *  Exported as `isReal` so the 3D cloud screens by the SAME rule — two screening
 *  rules is two answers about which samples exist. */
export function isReal(curve: string, v: unknown): v is number {
