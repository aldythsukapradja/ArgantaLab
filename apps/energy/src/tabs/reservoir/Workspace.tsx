...
export function ReservoirWorkspace({ scope }: { scope: string }) {
  ...
  return <div className="wsb-layout"><WorkflowTree groups={RESERVOIR_WORKFLOWS} active={tab.id} onSelect={setActive} label="Reservoir Management" /><WidgetBlueprintViewer group={group} tab={tab} scope={scope} /></div>;
}
