...
// `regrow` = REAL-TIME to re-ripen after a harvest (every crop re-harvests until
// you sickle it — ~⅔ of growMs, so a planted bed keeps paying out). Use the
// sickle to clear a plant and free the tile.
export const CROPS = {
  turnip: { id: 'turnip', name: 'Turnip', emoji: '🥬', season: 'spring', days: 3, growMs: 60000, regrow: 40000, seedCost: 20, sell: 40, color: 0xe0a3e8, ring: null },
  potato: { id: 'potato', name: 'Potato', emoji: '🥔', season: 'spring', days: 4, growMs: 120000, regrow: 80000, seedCost: 35, sell: 70, color: 0xd9b382, ring: null },
  carrot: { id: 'carrot', name: 'Carrot', emoji: '🥕', season: 'spring', days: 4, growMs: 120000, regrow: 80000, seedCost: 30, sell: 65, color: 0xf08a3c, ring: null },
  strawberry: { id: 'strawberry', name: 'Strawberry', emoji: '🍓', season: 'spring', days: 5, growMs: 180000, regrow: 110000, seedCost: 60, sell: 130, color: 0xe4425a, ring: 'numeria' },
  corn: { id: 'corn', name: 'Corn', emoji: '🌽', season: 'summer', days: 6, growMs: 240000, regrow: 150000, seedCost: 70, sell: 160, color: 0xf2c94c, ring: 'wordveil' },
  pumpkin: { id: 'pumpkin', name: 'Pumpkin', emoji: '🎃', season: 'fall', days: 6, growMs: 300000, regrow: 180000, seedCost: 80, sell: 200, color: 0xe07b2c, ring: 'life' },
};
