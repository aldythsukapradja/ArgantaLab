...
const argantaKinRows = [
  ...
  ['rhymefrog', 'Rhymefrog'],
  ['storyfox', 'Storyfox'],
  ['grammargon', 'Grammargon'],
  ['spellynx', 'Spellynx'],
  ['vowelcub', 'Vowelcub'],
  ['syllabee', 'Syllabee'],
  ['punctuapup', 'Punctuapup'],
  ['moodlamb', 'Moodlamb'],
  ['pulsepup', 'Pulsepup'],
  ['breezedeer', 'Breezedeer'],
  ['auroracrane', 'Auroracrane'],
  ['calmkoala', 'Calmkoala'],
  ['joyfawn', 'Joyfawn'],
  ['restbunny', 'Restbunny'],
  ['hearthog', 'Hearthog'],
  ...
  ['globewhale', 'Globewhale'],
  ['compassgull', 'Compassgull'],
  ['peakyak', 'Peakyak'],
  ['deltafrog', 'Deltafrog'],
  ['atlasram', 'Atlasram'],
  ['cloudcat', 'Cloudcat'],
  ['cometcolt', 'Cometcolt'],
  ['galaxyfawn', 'Galaxyfawn'],
  ['novabear', 'Novabear'],
...
const argantaKinSlots = argantaKinRows.map(([render, name]) => ({
  slotKey: `lashira.kin.${render}`,
  label: `${name} Kin`,
  category: 'kin',
  expectedW: 32,
  expectedH: 40,
  renderer: 'procedural',
  status: 'wired' as LashiraArtStatus,
  sourceFile: 'apps/lashira/web/src/game/farm-map.js',
  builtin: true,
}))
