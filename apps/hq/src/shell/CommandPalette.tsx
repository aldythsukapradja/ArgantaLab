...
import {
  ...
  Vault as VaultIcon, Waypoints, Frame, Scale, Terminal, FilePlus2, Swords, UserRound, Map, Music2, Film,
} from 'lucide-react'
...
const SURFACE_ICON: Record<SurfaceId, typeof Search> = {
  ...
  pixel: Grid2x2, vault: VaultIcon, architecture: Waypoints, battle: Swords, character: UserRound, world: Map, music: Music2, video: Film,
}
...
export function CommandPalette() {
  ...
  const cmds = useMemo<Cmd[]>(() => {
    const surfs: SurfaceId[] = ['home', 'portfolio', 'growth', 'data', 'vault', 'architecture', 'command', 'game', 'app', 'content', 'agents', 'broadcast', 'battle', 'character', 'world', 'music', 'video']
