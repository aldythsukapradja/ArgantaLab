...
const SURFACE_ICON: Record<SurfaceId, typeof Search> = {
  ...
  pixel: Grid2x2, vault: VaultIcon, architecture: Waypoints, battle: Swords, character: UserRound, world: Map, music: Music2, video: Film, media: Wand2, knowledge: Orbit, cinema: Film,
}
