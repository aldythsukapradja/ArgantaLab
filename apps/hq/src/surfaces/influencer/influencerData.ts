...
export const CREATORS: Creator[] = [
  {
    ...
    energy: 'Confident · Calm · Driven',
    promise: 'You are watching one person become capable of building something enormous.',
    differentiator: 'Mark Rober-scale visible experiments + founder mystery: every build is physical proof, and the mission stays concealed. Never talks about the future of AI — demonstrates it.',
    benchmarks: [
      ...
      { name: 'Tony Stark', takes: 'charisma, workshop cinema, unexplained long-term mission' },
    ],
    signatureLines: ['“This should not work.”', '“Again.”', '“That was the expensive version of failure.”', '“One person. One night. Let’s see.”', '“The future is mostly unfinished work.”'],
    rituals: [
      { name: 'Morning', theme: 'Humanity', frames: [
        { t: 'Environment', note: 'Workshop waking up, first coffee, city light' },
        { t: 'Fitness / prep', note: 'Training beat — discipline before building' },
        { t: 'Today’s build', note: 'One sentence: what gets attempted today' },
        { t: 'Poll', note: '“Would this work?” Yes / No' },
      ]},
      { name: 'Afternoon', theme: 'Progress', frames: [
        { t: 'Partial prototype', note: 'Half-built thing on the bench, hands close-up' },
        { t: 'Unexpected failure', note: 'Something breaks. Half-smile. “Again.”' },
        { t: 'Face-to-camera', note: '10-second honest reaction, no polish' },
      ]},
      { name: 'Night', theme: 'Payoff', frames: [
        { t: 'Result or cliffhanger', note: 'It works — or it dramatically doesn’t' },
        { t: 'Recovery / reflection', note: 'Quiet moment, watch adjust, dim workshop' },
        { t: 'Tomorrow’s problem', note: 'Open loop: the unresolved thing' },
      ]},
    ],
    weekly: ['Choose the mission', 'First failure', 'Audience predicts', 'Complication', 'Cinematic payoff', 'Lifestyle & character', 'Failure Report + next mission'],
    reels: {
      ...
      franchises: [
        { name: 'This Should Not Work', note: 'Visually impossible AI / hardware experiment' },
        { name: 'One Person Company', note: 'AI agents receive a real business mission' },
        { name: 'Build After Dark', note: 'Cinematic late-night prototype episodes' },
        { name: 'Future or Gimmick?', note: 'Honest verdict on a futuristic claim' },
        { name: 'The Failure Report', note: 'What broke, what it taught' },
        { name: 'Body and Machine', note: 'Athletics + sensing / prediction' },
        { name: 'Day X, Mission Hidden', note: 'Serialized founder journey, concealed destination' },
      ],
      hooks: ['“This should require twenty engineers.”', '“My AI team had six hours.”', '“The machine reacted before I moved.”', '“I still cannot tell you what this is for.”', '“This is what failure looks like at 2:13 a.m.”'],
    },
    posts: {
      pillars: [
        { name: 'Impossible builds', pct: 30 }, { name: 'Founder journey', pct: 20 }, { name: 'AI experiments', pct: 15 },
        { name: 'Physical discipline', pct: 15 }, { name: 'Failures', pct: 10 }, { name: 'Lifestyle', pct: 5 }, { name: 'Lashira clues', pct: 5 },
      ],
      carousel: 'Experiment breakdowns, system diagrams, before/after states, failure lessons — spectacle converted into credibility.',
      cadence: '4 Reels · 1 carousel · 1 premium still · daily Stories · 1 broadcast mission / week',
    },
    wardrobe: [
      { name: 'Tailored founder', pct: 40 }, { name: 'Fitted technical wear', pct: 25 }, { name: 'Athletic / training', pct: 20 },
      { name: 'Tasteful shirtless context', pct: 10 }, { name: 'Experimental styling', pct: 5 },
    ],
    spice: { safe: 70, provocative: 20, event: 10, note: 'Power, discipline, control — never “please look at my body.” Skin only in contexts that make sense (post-workout monologue, recovery, wearable tests). Max-spice stays an event, not a diet.' },
    guardrails: ['Disclosed AI persona in bio', 'No fabricated endorsements or lived experiences', 'Clearly adult styling always', 'Mystery = the mission, never “is he real?”'],
    igKit: {
      username: 'arganta',
      displayName: 'ARGANTA · The Impossible Builder',
      bio: 'I build things that should require a company.\nAI-generated character — real experiments, hidden mission.\n⌁ Day 1 of something enormous.',
      highlights: ['Builds', 'AI', 'Fitness', 'Logs', 'BTS'],
      pinned: ['WHO I AM — cinematic intro, mission concealed', 'BUILDER MINDSET — philosophy carousel', 'BEYOND LIMITS — best experiment reel'],
      cadence: 'Reels Mon/Wed/Fri/Sun · carousel Tue · premium still Sat · Stories daily (morning/afternoon/night ritual)',
    },
    promptCapsule: {
      base: 'Athletic East-Asian man in his mid-30s, lean muscular build, dark textured hair, light stubble, expressive eyes, controlled half-smile, premium masculine wardrobe, luxury watch. Cinematic moody workshop lighting, teal-and-gold palette, shallow depth of field, shot on 85mm. Confident, disciplined presence — power communicated through posture and context, never posed for display. Same face and identity in every image.',
      scenes: [
        'tailored black suit, adjusting watch before an experiment, holographic schematics behind him',
        'fitted dark technical vest, working late over a glowing prototype bench',
        'athletic wear, post-training, toweling off while reviewing data on a wall display',
        'morning routine, open collar, espresso, city skyline at dawn',
        'damaged shirt and tired half-smile beside a failed prototype, sparks settled',
      ],
      negative: 'no explicit or suggestive content, no underwear/swim-focus framing, nothing youth-coded, no real brand logos, no text artifacts, no extra fingers, keep face consistent with reference',
    },
  },
  {
    id: 'lashira',
    ...
    reels: {
      ...
      hooks: ['“AURA, bring the system online.”', '“Five agents woke me at 3 a.m.”', '“The system refused my command.”', '“AURA, why is there another user?”', '“The system found Arganta.”'],
    },
    posts: {
      pillars: [
        { name: 'AURA activations', pct: 30 }, { name: 'Agent behavior', pct: 20 }, { name: 'Cinematic engineering', pct: 15 },
        { name: 'Technical explanation', pct: 15 }, { name: 'Human vs AI tension', pct: 10 }, { name: 'Lifestyle', pct: 5 }, { name: 'Arganta clues', pct: 5 },
      ],
