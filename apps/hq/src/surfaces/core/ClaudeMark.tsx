...
// external asset, so it stays embeddable + CSP-clean. Used wherever the Claude
// Code brain is surfaced (model pill, completion capsule) so the founder can
// tell Claude Code apart from Core at a glance.
const RAYS = 12
