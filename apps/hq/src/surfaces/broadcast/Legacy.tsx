  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      <div className="spread" style={{ alignItems: 'flex-end', flexWrap: 'wrap', gap: 10 }}>
        <div>
          <div className="h1">Legacy tools</div>
          <div className="sub">The original Discover-feed toolset — Catalogue, Autopilot, Studio, Prompts, Import, Library &amp; Research. New posts are designed in the Post Studio.</div>
        </div>
        <div className="seg">
