...
import { CONTENT_PACK_16 } from './contentPack16'
...
export const LOCAL_ITEMS: Item[] = [...NUM_ITEMS, ...WRD_ITEMS, ...WON_ITEMS, ...LOG_ITEMS, ...WLD_ITEMS, ...LIF_ITEMS, ...EXTRA_ITEMS, ...EXPLORER_PACK, ...(STAGE_PACKS as Item[]), ...(CONTENT_PACK_2 as Item[]), ...(CONTENT_PACK_3 as Item[]), ...(CONTENT_PACK_4 as Item[]), ...(CONTENT_PACK_5 as Item[]), ...(CONTENT_PACK_6 as Item[]), ...(CONTENT_PACK_7 as Item[]), ...(CONTENT_PACK_8 as Item[]), ...(CONTENT_PACK_9 as Item[]), ...(CONTENT_PACK_10 as Item[]), ...(CONTENT_PACK_11 as Item[]), ...(CONTENT_PACK_12 as Item[]), ...(CONTENT_PACK_13 as Item[]), ...(CONTENT_PACK_14 as Item[]), ...(CONTENT_PACK_15 as Item[]), ...(CONTENT_PACK_16 as Item[])]
