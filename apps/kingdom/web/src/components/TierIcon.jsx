// Faceted gem crest tinted by tier colour — ArgantaLab's rank badge, ported
// from apps/web/src/components/rank/TierIcon.tsx so the arena HUD shows the
// same premium crest instead of a bare letter/glyph.
...
export default function TierIcon({ color, glyph, size = 46 }) {
