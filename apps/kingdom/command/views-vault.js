...
(function () {
  ...
  Views.lab = function (root) {
    root.innerHTML = `
      <div class="lab-embed">
        <iframe src="http://localhost:8322/" title="Character Lab"></iframe>
        <div class="lab-embed-note">Standalone: <a href="http://localhost:8322/" target="_blank">localhost:8322</a>
          — run the <code>kingdom-web</code> dev server if this frame is empty.</div>
      </div>`;
  };
})();
