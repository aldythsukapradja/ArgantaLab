      ...
      <div className="w-full max-w-sm bg-[#0a0a0a]/90 backdrop-blur-xl border border-white/10 rounded-xl p-10 shadow-2xl relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-white/5 border border-white/10 text-white/70 font-medium py-2.5 rounded-md hover:bg-white/10 hover:text-white transition-all text-sm"
          >
            Continue with Local Engine only
          </button>
          <p className="text-center text-[11px] text-white/20 -mt-2">
            Sovereign tier — runs on your own GPU via ComfyUI, no key needed.
          </p>
        </form>
      </div>
    </div>
