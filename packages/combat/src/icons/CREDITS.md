...
Action-cluster skill icons are from [game-icons.net](https://game-icons.net/),
licensed **CC BY 3.0** (https://creativecommons.org/licenses/by/3.0/). The
foreground paths are vendored into `paths.js`; original SVGs are kept in `./svg`.
